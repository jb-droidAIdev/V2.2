...
describe('Business Days Utility', () => {
  describe('isBusinessDay', () => {
    it('should return true for Monday-Friday', () => {
      // Monday, Jan 6, 2025
      const monday = DateTime.fromISO('2025-01-06', {
        zone: 'America/New_York',
      });
      expect(isBusinessDay(monday)).toBe(true);

      // Friday, Jan 10, 2025
      const friday = DateTime.fromISO('2025-01-10', {
        zone: 'America/New_York',
      });
    ...
    it('should return false for Saturday-Sunday', () => {
      ...
      const saturday = DateTime.fromISO('2025-01-11', {
        zone: 'America/New_York',
      });
      expect(isBusinessDay(saturday)).toBe(false);

      // Sunday, Jan 12, 2025
      const sunday = DateTime.fromISO('2025-01-12', {
        zone: 'America/New_York',
      });
  ...
  describe('addBusinessDays', () => {
    it('should add 3 business days correctly (Agent window)', () => {
      ...
      const start = DateTime.fromISO('2025-01-06', {
        zone: 'America/New_York',
      });
    ...
    it('should skip weekends when adding business days', () => {
      ...
      const start = DateTime.fromISO('2025-01-10', {
        zone: 'America/New_York',
      });
  ...
  describe('getBusinessDayDeadline', () => {
    it('should return deadline at 5 PM EST', () => {
      const start = DateTime.fromISO('2025-01-06T09:00:00', {
        zone: 'America/New_York',
      });
  ...
  describe('SLA Scenarios from Requirements', () => {
    it('Agent Acknowledge/Dispute Window: 3 business days', () => {
      ...
      const releaseDate = DateTime.fromISO('2025-01-06T09:00:00', {
        zone: 'America/New_York',
      });
    ...
    it('Dispute Resolution: Ops TL 1 business day', () => {
      ...
      const disputeDate = DateTime.fromISO('2025-01-08T14:00:00', {
        zone: 'America/New_York',
      });
